...
const navLinks = [
  ...
  { href: "#faq", label: "FAQ" },
  { href: SOCIAL.whatsapp.url, label: "WhatsApp", external: true, icon: "whatsapp" },
  { href: SOCIAL.discord.url, label: "Suporte", external: true, icon: "discord" },
  { href: SOCIAL.instagram.url, label: "Instagram", external: true, icon: "instagram" },
];
