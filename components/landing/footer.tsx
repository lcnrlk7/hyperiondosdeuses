...
const footerLinks = {
  ...
  Suporte: [
    { label: "FAQ", href: "#faq" },
    { label: "Discord", href: SOCIAL.discord.url, external: true },
    { label: "Instagram", href: SOCIAL.instagram.url, external: true },
    { label: "Central de Ajuda", href: SOCIAL.discord.url, external: true },
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-3 mb-4 text-sm text-muted-foreground">
              ...
              <span>Brasil - Operação 100% Digital</span>
            </div>
            <a 
              href="https://wa.me/5534999353187"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 mb-4 text-sm text-muted-foreground hover:text-green-500 transition-colors"
            >
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-xl bg-green-500 flex items-center justify-center text-white hover:scale-110 hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300"
              >
        ...
        <div className="border-t border-border mt-12 pt-12">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-foreground mb-3">Entre em Contato</h3>
            <p className="text-muted-foreground text-sm max-w-md mx-auto">
              Dúvidas, sugestões ou parcerias? Fale conosco através das nossas redes sociais.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 flex-wrap">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 px-6 py-3 rounded-xl bg-green-500/10 border border-green-500/30 hover:border-green-500/60 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300"
            >
              ...
              <div className="text-left">
                <span className="text-white font-medium">(34) 99935-3187</span>
            ...
            >
              ...
              <div className="text-left">
                <span className="text-white font-medium">{SOCIAL.instagram.handle}</span>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 px-6 py-3 rounded-xl bg-[#5865F2]/10 border border-[#5865F2]/30 hover:border-[#5865F2]/60 hover:shadow-lg hover:shadow-[#5865F2]/20 transition-all duration-300"
            >
              <div className="w-10 h-10 rounded-lg bg-[#5865F2] flex items-center justify-center group-hover:scale-110 transition-transform">
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z" />
                </svg>
              </div>
              <div className="text-left">
                <span className="text-white font-medium">Comunidade</span>
                <p className="text-xs text-muted-foreground">{SOCIAL.discord.handle}</p>
              </div>
            </Link>
            <a
              href="mailto:contato@hyperionpay.com"
